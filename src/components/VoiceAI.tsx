          ...
          navigate("/add-questions", {
            state: {
              formData: {
                ...
                surveyTitle:
                  data.surveyData.surveyTitle || "AI-Generated Survey",
        ...
        if (
          ...
          setTimeout(() => {
            try {
              ...
              console.error(
                "Failed to restart recognition after speaking finished:",
                err,
              );
            }
          }, 300);
      ...
      utterance.onerror = () => {
        ...
        if (
          ...
          try {
            ...
            console.error(
              "Failed to restart recognition after speaking error:",
              err,
            );
          }
        }
          ...
          >
              ...
              <div className="flex items-center gap-3">
                  ...
                  <img
                    ...
                    onError={(e) => {
                      (e.target as HTMLImageElement).src =
                        "https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=80&auto=format&fit=crop&q=60";
                    }}
                  />
                ...
                <div>
                  <div className="flex items-center gap-1.5">
                    <h3
                      className={`text-[15px] font-extrabold ${currentTheme.headerText}`}
                    >
                      Form Copilot
                    </h3>
                    <span className="bg-[#000E54] text-white text-[9px] font-black uppercase px-1 py-0.5 rounded tracking-wide leading-none">
                      AI
                    </span>
                  </div>
                ...
                >
                  {msg.sender === "ai" && (
                    <img
                      ...
                      onError={(e) => {
                        (e.target as HTMLImageElement).src =
                          "https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=40";
                      }}
                    />
                  )}
            ...
            <div className="flex items-center justify-between px-4 py-2 border-b border-gray-50 bg-white shrink-0">
              ...
              <div className="flex items-center gap-2">
                <span
                  className={`text-[10px] font-extrabold ${alwaysOn ? "text-orange-600" : "text-gray-400"}`}
                >
                  {alwaysOn ? "ON" : "OFF"}
                </span>
                <button
                  ...
                  title={
                    alwaysOn
                      ? "Voice input remains active"
                      : "Enable hands-free mode"
                  }
                >
                  <span
                    className={`pointer-events-none inline-block h-3 w-3 transform rounded-full bg-white shadow-sm ring-0 transition duration-200 ease-in-out ${alwaysOn ? "translate-x-3" : "translate-x-0"}`}
                  />
                </button>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-3xl p-2.5 shadow-md hover:shadow-lg focus-within:border-orange-300 focus-within:ring-2 focus-within:ring-orange-100/40 transition-all flex flex-col gap-2.5 mx-4 mb-4 mt-2 shrink-0">
              <div className="flex flex-wrap items-center gap-1.5 px-1 pt-0.5">
                {activeTag && (
                  <span
                    className={`flex items-center gap-1 ${currentTheme.badgeBg} ${currentTheme.badgeText} text-xs font-semibold px-2.5 py-0.5 rounded-full shrink-0 border`}
                  >
                    {activeTag}
                    <button
                ...
                <input
                  ...
                  onKeyDown={(e) =>
                    e.key === "Enter" && handleSendPrompt(textInput)
                  }
                  placeholder={
                    isListening
                      ? "Listening... Speak now..."
                      : activeTag
                        ? "Add details or details..."
                        : "Ask me to build a form..."
                  }
              ...
              <div className="flex justify-between items-center pt-2.5 border-t border-gray-100/60">
                <div className="flex items-center gap-1.5">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      title={
                        isListening
                          ? "Voice Input is ON - Click to turn off"
                          : "Voice Input is OFF - Click to turn on"
                      }
                    >
                      {isListening ? (
                ...
                <button
                  ...
                  disabled={
                    isLoading ||
                    (!textInput.trim() && !activeTag && !attachedFile)
                  }
                ...
                >
                  {isLoading ? (
                    ...
                    <>
                      <span className="text-sm font-black">↑</span> Send
                    </>
                  )}
                </button>
              </div>
