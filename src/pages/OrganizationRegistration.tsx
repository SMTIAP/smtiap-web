            ...
            <div className="w-full max-w-4xl px-6 pb-10">
                ...
                <div className="bg-white border border-slate-100 rounded-2xl shadow-sm p-10 flex flex-col gap-8">
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <select name="country" value={formData.country} onChange={handleChange} className="w-full rounded-lg border border-slate-200 px-4 py-2 focus:ring-2 focus:ring-blue-400 outline-none">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <div className="flex gap-6">
                            <label className="flex items-center gap-2">
                                <input type="radio" name="orgType" value="profit" checked={formData.orgType === "profit"} onChange={handleChange}/>
                                <span className="text-sm text-slate-700">For Profit</span>
                            </label>

                            <label className="flex items-center gap-2">
                                <input type="radio" name="orgType" value="non-profit" checked={formData.orgType === "non-profit"} onChange={handleChange}/>
                    ...
                    {/* Submit */}
                    <button onClick={handleSubmit} className="mt-4 bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-10 rounded-lg transition self-center">
