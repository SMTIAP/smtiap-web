  ...
  const handleFinalize = async (status: "Running" | "Draft") => {
    try {
      const payload = {
        ...
        primaryColor, themeColor: primaryColor, pages, status, tenantId: "default",
      };
      ...
      <div className="flex max-w-200 py-12 px-6 flex-col gap-6 w-full text-left">
        <div className="flex justify-between items-center w-full mb-2">
          <button
            onClick={() => {
              if (surveyId) {
                navigate("/add-questions", { state: { surveyId, formData: { surveyTitle, description, logo, websiteUrl, customizeBranding, themeColor: primaryColor } } });
              } else { navigate(-1); }
            }}
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-200 dark:border-slate-700 overflow-hidden transition-colors duration-300">
          ...
          <div className="p-10">
            ...
            {pages.length > 0 ? (
              <div className="space-y-8 mb-12">
                <h3 className="text-sm font-bold text-gray-900 dark:text-white flex items-center gap-2">
                  <Layout size={16} style={{ color: primaryColor }} /> Content Summary
                </h3>
              ...
              <div className="mb-12 p-8 border-2 border-dashed border-gray-100 dark:border-slate-700 rounded-2xl text-center">
                ...
                <button onClick={() => navigate(-1)} className="mt-3 text-sm font-medium" style={{ color: primaryColor }}>
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-3 pt-8 border-t border-gray-100 dark:border-slate-700">
              ...
              <button onClick={() => handleFinalize("Running")} style={{ backgroundColor: primaryColor }}
