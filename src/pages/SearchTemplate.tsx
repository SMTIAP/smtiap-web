      ...
      <div className="flex max-w-[1200px] py-12 px-8 flex-col items-start gap-10 w-full">
        <div className="flex justify-between items-center w-full">
          <div className="flex items-center gap-6">
            <BackButton />
            <h1 className="text-[#0F172A] dark:text-white text-4xl font-black tracking-tight">
              Search Template
            </h1>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-10 w-full">
          ...
          <div className="w-full">
            <div className="flex items-end justify-between mb-4">
              <h2 className="text-[#0F172A] dark:text-white text-xl font-black tracking-tight">
                Survey Drafts
              </h2>
            ...
            {loadingDrafts ? (
              <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 px-4 py-3 text-sm text-slate-500 dark:text-slate-400">
                Loading drafts...
              </div>
                ...
                {uniqueDraftSurveys.map((survey) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="px-2">
                        <p className="text-[#1E293B] dark:text-white font-black text-sm line-clamp-1">
                          {title}
                        </p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8 w-full">
            ...
            >
              ...
              <div className="px-2">
                <p className="text-[#1E293B] dark:text-white font-black text-sm">
                  New Empty
                </p>
      ...
      {loading && (
        <div className="fixed inset-0 bg-white/60 dark:bg-black/60 backdrop-blur-md flex items-center justify-center z-50">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-teal-700 dark:text-teal-300 font-black text-xs uppercase tracking-widest">
              Preparing Template...
            </p>
          </div>
        </div>
