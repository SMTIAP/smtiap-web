      ...
      <div className="relative bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-gray-100 dark:border-slate-700 p-5 max-w-sm w-full z-10 max-h-[85vh] overflow-y-auto mt-16">
        ...
        <div className="mb-4 bg-slate-50 dark:bg-slate-900 rounded-xl p-3 border border-slate-100 dark:border-slate-700">
          <div className="flex items-center justify-between">
            ...
            <div
              ...
              className={`w-8 h-4 rounded-full relative cursor-pointer transition-all duration-200 ${isPasswordProtected ? "bg-indigo-600" : "bg-slate-200 dark:bg-slate-600"}`}
            >
              <div
                className={`absolute top-0.5 w-3 h-3 bg-white rounded-full transition-all duration-200 ${isPasswordProtected ? "left-4" : "left-0.5"}`}
              />
            </div>
          </div>
          {isPasswordProtected && (
          ...
          {!isPasswordProtected && (
            <p className="text-[10px] text-slate-400 mt-1">
              Anyone with the link can access this.
            </p>
          )}
        </div>

        <p className="text-[10px] font-bold uppercase text-slate-400 tracking-widest mb-1.5">
          Survey link
        </p>
        <div className="flex gap-2 mb-4">
          <input
            readOnly
            value={surveyLink}
            className="flex-1 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-2 text-[11px] font-medium text-slate-600 dark:text-slate-300 outline-none"
          />
          <button
        ...
        <div className="flex items-center gap-4 bg-slate-50 dark:bg-slate-900 rounded-xl p-3 border border-slate-100 dark:border-slate-700">
          ...
          <div className="flex flex-col gap-2">
            <p className="text-xs text-slate-500 dark:text-slate-400 font-medium leading-snug">
              Download & share survey QR
            </p>
            <button
              onClick={downloadQR}
              className="flex items-center gap-1.5 text-indigo-600 dark:text-indigo-400 font-bold text-xs hover:text-indigo-800 transition-colors"
            >
    ...
    return (
      <div className="flex h-screen items-center justify-center bg-[#F8FAFC] dark:bg-[#0F172A]">
        <div className="animate-pulse flex flex-col items-center gap-4">
          ...
          <p className="text-indigo-900 dark:text-indigo-300 font-bold tracking-widest uppercase text-xs">
            Loading Workspace
          </p>
        </div>
      </div>
