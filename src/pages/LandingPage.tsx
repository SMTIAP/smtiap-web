        ...
        <div className="max-w-7xl mx-auto px-6 h-full flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center gap-4 bg-white/40 border border-white/60 p-1.5 rounded-full shadow-inner pr-5">
            ...
            <div className="text-[13px] font-[600] text-slate-500">
              <span className="text-[#5C38E1] font-[800]">1k+</span> insights
              extracted
            </div>
          </div>
          ...
          <div className="flex items-center gap-6">
            <Link
              to="/login"
              className="text-[15px] font-[600] text-[#475569] hover:text-[#5C38E1] transition-colors"
            >
              Sign In
            </Link>
            <Link
              to="/register"
              className="bg-gradient-to-br from-[#5C38E1] to-[#8E6BFF] text-white px-7 py-2.5 rounded-full font-[700] text-[14px] shadow-xl shadow-purple-500/20 hover:scale-105 transition-transform inline-block text-center"
            >
              Create Free Survey
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative min-h-[500px] flex items-center justify-center">
            <div className="relative w-full h-full max-w-[500px]">
              ...
              >
                <div className="text-[11px] font-[800] text-slate-400 uppercase mb-3">
                  Overall Sentiment
                </div>
                <div className="flex items-center gap-3">
                  <div className="text-[24px] font-black text-[#5C38E1]">
                    94%
                  </div>
