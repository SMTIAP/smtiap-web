...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F4F6FA] dark:bg-slate-950 text-[#2C2F32] dark:text-slate-200 selection:bg-[#5C38E1] selection:text-white overflow-x-hidden font-sans">
      ...
      <section className="relative pt-44 pb-32 px-6">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-[54px] md:text-[72px] leading-[0.95] font-[800] tracking-[-0.04em] text-[#1e1b4b] dark:text-slate-100 mb-8 font-manrope">
              Smart Surveys. <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#5C38E1] to-[#A391FF]">
                Instant Insights.
              </span>
            </h1>
            <p className="text-[19px] leading-relaxed text-[#595C5F] dark:text-slate-400 max-w-[540px] mb-10">
          ...
          <div className="relative min-h-[500px] flex items-center justify-center">
            <div className="relative w-full h-full max-w-[500px]">
              ...
              <motion.div
                ...
                className="absolute top-[-20px] left-[-40px] w-[260px] p-5 rounded-[24px] z-10 bg-white/45 dark:bg-slate-800/60 backdrop-blur-xl border border-white/50 dark:border-slate-700/50 shadow-2xl"
              >
              ...
              <motion.div
                ...
                transition={{ duration: 0.8 }}
                className="relative w-full p-8 rounded-[40px] shadow-[0_20px_50px_rgba(0,0,0,0.1)] z-20 bg-white/50 dark:bg-slate-800/70 backdrop-blur-2xl border border-white/60 dark:border-slate-700/60 overflow-hidden"
              >
                <div className="flex justify-between items-start mb-8">
                  <div className="space-y-1">
                    <h3 className="font-[800] text-[#1e1b4b] dark:text-slate-100 text-[18px]">
                      Analyzed Results
                    </h3>
                ...
                <motion.div
                  ...
                  className="mb-10 p-4 bg-[#5C38E1]/5 dark:bg-purple-500/10 rounded-2xl border border-[#5C38E1]/10 dark:border-purple-500/20 flex gap-4 items-start relative z-10"
                >
      ...
      <section className="py-24 px-6 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-white/45 dark:bg-slate-800/60 backdrop-blur-xl rounded-[60px] p-12 lg:p-20 grid lg:grid-cols-2 gap-16 items-center border border-white/50 dark:border-slate-700/50"
          >
            <div className="space-y-8">
              <h2 className="text-[40px] md:text-[52px] font-[800] text-[#1e1b4b] dark:text-slate-100 leading-[1.1] tracking-tight font-manrope">
                See the answers <br />
                before they're typed.
              </h2>
              <p className="text-[18px] text-[#595C5F] dark:text-slate-400 leading-relaxed">
            ...
            <div className="relative bg-white/40 dark:bg-slate-800/40 p-8 rounded-[40px] border border-white/60 dark:border-slate-700/60 shadow-inner min-h-[300px] flex flex-col justify-end">
              ...
              <div className="absolute top-10 right-10">
                <div className="bg-white/70 dark:bg-slate-700/80 backdrop-blur-md px-4 py-2 rounded-xl text-[11px] font-bold border border-white dark:border-slate-600 shadow-lg dark:text-slate-200">
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-3 gap-10">
          {[
            ...
            return (
              ...
              >
                <div
                  className={`w-16 h-16 rounded-3xl flex items-center justify-center mb-8 ${isActive ? "bg-white/20" : "bg-purple-100 dark:bg-purple-500/20"}`}
                >
                  <feat.icon
                    className={`w-8 h-8 ${isActive ? "text-white" : "text-[#5C38E1] dark:text-purple-400"}`}
                  />
                </div>
                <h3 className="text-[24px] font-[800] mb-4 font-manrope dark:text-slate-100">
                  {feat.title}
                </h3>
                <p
                  className={`transition-colors duration-500 ${isActive ? "text-white/80" : "text-slate-500 dark:text-slate-400"}`}
                >
                  {feat.desc}
                </p>
                {
                  <div className="mt-8 pt-8 border-t border-slate-300 dark:border-slate-600 text-[14px] font-bold dark:text-slate-300">
                    {feat.stat}
                  </div>
                }
              </motion.div>
      ...
      <section className="py-32 px-6">
        <div className="max-w-5xl mx-auto relative group">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-white/50 dark:bg-slate-800/60 backdrop-blur-2xl p-16 md:p-24 rounded-[60px] relative z-10 text-center border border-white/60 dark:border-slate-700/60"
          >
            <h2 className="text-[44px] md:text-[60px] font-[800] text-[#1e1b4b] dark:text-slate-100 mb-8 tracking-tighter leading-none font-manrope">
              Turn your data into <br />
              <span className="text-[#5C38E1] dark:text-purple-400">
                decisions.
              </span>
            </h2>
            <p className="text-[19px] text-slate-500 dark:text-slate-400 max-w-xl mx-auto mb-12">
      ...
      {/* Footer */}
      <footer className="pt-24 pb-12 px-8 border-t border-slate-200 dark:border-slate-800 bg-white/30 dark:bg-slate-900/50 backdrop-blur-md">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-6 gap-16 mb-20">
            <div className="col-span-2">
              <div className="text-[22px] font-[900] text-[#0F172A] dark:text-slate-100 font-manrope mb-6 flex items-center gap-2">
                <FileChartColumnIncreasing className="text-[#5C38E1] dark:text-purple-400" />{" "}
                MTSP
              </div>
              <p className="text-slate-500 dark:text-slate-400 max-w-xs leading-relaxed text-[15px]">
            ...
            <div className="col-span-2">
              <div className="bg-white/40 dark:bg-slate-800/50 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 relative overflow-hidden group">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center pt-12 border-t border-slate-100 dark:border-slate-800 gap-6">
