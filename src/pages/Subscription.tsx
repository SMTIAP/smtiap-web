...
const plans: PricingPlan[] = [
  {
    ...
    monthlyPrice: 0,
    yearlyPrice: 0,
    features: ["1 Member (You)", "Basic features", "Community support"],
  ...
  },
  {
    ...
    monthlyPrice: 1000,
    yearlyPrice: 11000,
    features: ["10 Members", "All basic features", "Priority support", "Advanced analytics"],
  ...
  },
  {
    ...
    monthlyPrice: 1500,
    yearlyPrice: 17000,
    features: ["100 Members", "All startup features", "Dedicated account manager", "Custom integrations"],
    buttonText: "Get Started",
  },
];
